        ...
        try {
            ...
            MalvinTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = '𝐋𝚵𝚭𝐊𝐔𝐒𝚮-𝚻𝚳𝐃~' + stringSession;  // Prepend your name to the session ID
                    ...
                    await MalvinTechInc.sendMessage(userJid, { text: `Hey there, 𝐋𝚵𝚭𝐊𝐔𝐒𝚮-𝚻𝚳𝐃 User!* 👋🏻

Thanks for using *𝐋𝚵𝚭𝐊𝐔𝐒𝚮-𝚻𝚳𝐃* — your session has been successfully created!
